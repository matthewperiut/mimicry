...
public class KnightRenderer extends HumanoidMobRenderer<MossKnightEntity, KnightRenderer.State, KnightRenderer.Model> {
	...
	public KnightRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new GreatswordLayer(this));
	}
	...
	private static class GreatswordLayer extends RenderLayer<State, Model> {
